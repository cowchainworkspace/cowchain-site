            ...
            {benefitsData.map((benefit, index) => {
              return (
                <Step data={index + 1} key={benefit.title + index}>
                  <article
                    className={cn(
                      "px-default relative flex  max-h-full grow flex-col items-center justify-center  overflow-hidden border-b border-b-th-fade py-6   will-change-transform lg:py-8",
                      {
