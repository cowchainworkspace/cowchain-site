...
export default function Team() {
  return (
    <section
      id="team"
      className="relative flex items-center justify-center border-b border-b-th-fade pt-[60px] pb-[40px] md:py-[60px] text-center md:pb-[84px] md:pt-[126px] lg:text-left"
    >
      <div className="relative max-w-[1440px]  grid w-full grid-cols-1 lg:grid-cols-5 min-[2000px]:grid-cols-6">
        <div className="px-[20px] md:px-[88px] z-10 flex flex-col gap-y-6 pb-[84px] md:pb-[60px] lg:col-span-5 lg:flex-row min-[2000px]:col-span-6">
          <div>
          ...
          <p className="leading-[22px] block text-left text-[16px] text-[#BBBBBB] md:hidden">
            The team, as part of a Web3 development <br /> agency, consists of 50+
            Web3-native <br />  developers with deep expertise in blockchain <br />  technology.
            Our aim is to empower <br />  businesses by providing innovative, secure, <br /> 
