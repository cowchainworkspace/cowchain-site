    ...
    <>
      ...
      <section className="overflow-visible">
        <HeroSection
          title={
            <>
              Build Your Crypto Lottery{" "}
              <br className="hidden custom1400:block" /> Platform with White
              Label <br className="hidden custom1400:block" /> Solutions
            </>
          }
        ...
        <ExpertiseServices
          title={
            <>
              Why White Label <br /> Is the Smart Way <br /> to Build Your{" "}
              <br /> Crypto Lottery
            </>
          }
        ...
        <KeyFeatures
          ...
          desc={
            <>
              ...
              looking to expand your ecosystem, launching with white label
              lottery solutions gives you a reliable, fast, and future-ready
              path to market. With a team that understands both blockchain
              infrastructure and user experience, you’re not just launching a
              lottery — you’re building a product people trust
            </>
          }
          noBg={true}
