    ...
    <>
      ...
      <section className="overflow-visible">
        ...
        <Achievements
          ...
          desc={
            <>
              ...
              measures, fostering <br className="hidden custom1400:block" />{" "}
              trust among users.
            </>
          }
        />
        ...
        <ExpertiseServices
          ...
          desc={
            <>
              Modern crypto wallets are transforming into comprehensive
              financial tools by <br className="hidden custom1400:block" />{" "}
              integrating advanced payment systems. These enhancements empower
              both <br className="hidden custom1400:block" /> users and
              businesses, making wallets more versatile in the digital economy
            </>
          }
          itemClasses="md:text-[20px]"
          ...
          desc={
            <>
              ...
              <p className="mt-[20px] font-manrope text-[16px] font-[500] leading-[24px] text-[#BBBBBB]">
                With extensive experience in crypto wallet software and
                blockchain development, our team delivers innovative{" "}
              ...
              <p className="mt-[20px] text-[16px] font-[500] leading-[24px] text-[#BBBBBB]">
                Our services include post-deployment support, regular updates,
                and dedicated assistance to ensure your wallet{" "}
        ...
        <KeyFeatures
          ...
          desc={
            <>
              ...
              <br className="hidden lg:block" />
              with users and stand out in the market. Contact us today to
              explore how our crypto wallet integration{" "}
              <br className="hidden lg:block" />
        ...
        <WhiteLabelCases
          ...
          desc={
            <>
              ...
              user experience. Whether it’s embedded wallets, multi-chain
              support, or mobile-first services deliver real impact where it
              counts: in retention, security, and usability.
            </>
          }
