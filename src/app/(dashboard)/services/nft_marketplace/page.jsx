        ...
        <Achievements
          ...
          desc={
            <>
              ...
              designed to support
              <br className="hidden custom1430:block" /> the creation, buying,
              and selling of non-fungible
              <br className="hidden custom1430:block" /> tokens (NFTs). Unlike
              custom development,
              <br className="hidden custom1430:block" /> which requires building
              a solution from scratch,
              <br className="hidden custom1430:block" /> white label
              marketplaces offer{" "}
              <span className="violet-gradient-text">
