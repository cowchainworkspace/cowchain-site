          ...
          desc={
            <>
              ...
              <span className="violet-gradient-text">
                ...
                <br className="hidden custom1400:block" /> accessibility, and
                the elimination of intermediaries
              </span>
              . <br className="hidden custom1400:block" /> Intuitive blockchain
              UI and blockchain UX are crucial{" "}
        ...
        <KeyFeatures
          ...
          desc={
            <>
              ...
              both novices and experienced users. This approach fosters
              engagement by aligning the platform’s functionality with the
        ...
        <KeyFeatures
          ...
          desc={
            <>
              ...
              cutting-edge innovations, these designs enhance usability,
              security, and engagement. Let Cowchain help you transform your
              vision into reality with tailored Web3 applications that resonate
              with your audience
            </>
          }
          noBg={true}
