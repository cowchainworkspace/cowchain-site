...
export function TeckStack({ title, desc }) {
  return (
    <section
      id="expertise"
    ...
    >
      <div className="grid  grid-cols-3  gap-y-[42px] md:gap-x-[100px]">
        <div className="col-span-1 row-span-3 flex flex-col items-start gap-[26px] md:justify-start">
