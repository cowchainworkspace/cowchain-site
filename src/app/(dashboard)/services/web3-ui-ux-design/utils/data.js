...
export const web3DesignFAQData = [
  {
    title: "What makes Web3 UI/UX design different from Web2?",
    content:
      "Web3 design focuses on decentralized interactions, wallet connectivity, and blockchain-specific actions like staking or minting. It requires a deeper understanding of crypto-native flows and user expectations, especially for onboarding and trust. We design with these unique needs in mind to deliver intuitive, secure, and scalable interfaces."
  },
  {
    title: "How long does it take to design a Web3 application interface?",
    content: `A typical UI/UX project takes 3–5 weeks depending on scope. This includes research, wireframes, high-fidelity design, and interactive prototypes. We also account for responsiveness and cross-platform testing to ensure consistency across devices.`
  },
  {
    title: "Can you help redesign an existing Web3 app?",
    content: `Absolutely. Many of our projects involve improving live Web3 products. Whether your users struggle with wallet flows or you need a visual overhaul to support new features, we can step in and enhance the interface without disrupting your current architecture.`
  }
];
...
export const deliversWeb3DesignData = [
  {
    title: "Our Approach to Web3 Design",
    desc: "At Cowchain, we focus on delivering next-generation, user-friendly blockchain design solutions. Our team emphasizes usability, security, and adaptability, ensuring your platform meets user expectations while standing out in the competitive Web3 ecosystem"
  },
  {
    title: "Why Choose Cowchain for Blockchain UI/UX Design",
    desc: "Cowchain’s expertise in UI/UX blockchain design sets us apart. With a proven track record, a user-first approach, and a portfolio of accomplished projects, we deliver Web3 solutions that prioritize your goals and user satisfaction. Whether you’re launching a DeFi platform or an NFT marketplace, our team ensures your platform is intuitive, secure, and visually engaging"
  }
];
