      ...
      <div className="px-default md-border-r flex w-full border-b border-b-th-fade py-10 md:w-1/2 md:py-0">
        <div className="relative grid grid-cols-1">
          ...
          <div className="mb-16 flex flex-col items-center justify-center gap-y-8 px-4 text-center   text-white ">
            <h3 className="z-10 mx-auto cursor-default text-center font-roc text-2xl   uppercase md:text-[54px]">
              Our Smart Contracts Development Process
            </h3>

            <span className="z-10 max-w-lg  text-center text-sm text-[#bbb] md:text-base">
              We follow a rigorous and consistent smart contract development
              process to ensure high quality, security, and customer compliance:
            </span>
                ...
                >
                  <div className="relative flex items-start justify-start">
                    <article
                      style={benefit.style}
                      className={cn(
                        "relative flex h-[430px] min-h-[250px] grow  items-start justify-start overflow-hidden  bg-black px-5    duration-1000  will-change-transform ",
                    ...
                    >
                      <div className="mx-6 flex  flex-col items-center justify-center">
                        <div
                          className={cn(
                            "absolute h-[120vh] w-[1px] bg-[#808080]",
                            {
                              "h-[7vh]": index === 4
                            }
                          )}
                      ...
                      >
                        <h2
                          className={cn(
                            "mb-16 flex max-w-[285px]  text-base text-white",
                            benefit.textStyle,
                            benefit.headerStyle
                          )}
                        >
