...
export const SmartContractIndustriesData = [
  {
    title: "Healthcare",
    text: "Smart contracts in healthcare provide secure management of patient records and protection of sensitive data. They automate insurance verification, claims processing, and payment processes. They also track the movement of drugs through the supply chain to ensure their authenticity",
    icon: health
  },
  {
    title: "Government",
    text: "Smart contracts increase the transparency and efficiency of public services. They create secure electronic voting systems and automate the distribution of public funds. Smart contracts ensure transparency in public procurement and maintain immutable registers of property, companies, and licenses",
    icon: GovernmentIcon
  },
  ,
  {
    title: "Real Estate",
    text: "Smart contracts automate buying, selling, and renting real estate without intermediaries. They ensure transparency of transactions and access to up-to-date information. They create decentralized real estate registries with immutable property records and automate real estate management",
    icon: RealEstateDefiIcon
  },
  {
    title: "Energy",
    text: "Smart contracts automate energy trading, providing transparent transactions and fast payment. They are also used for tracking energy consumption and automatic billing. Smart contracts promote the development of distributed energy and direct energy sales to consumers",
    icon: FinanceIcon
  }
];
...
export const OtherSmartContractData = [
  {
    text: "Automating processes and operations, increasing efficiency"
  },
  {
