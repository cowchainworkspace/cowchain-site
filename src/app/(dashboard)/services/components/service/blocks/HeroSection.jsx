...
export const HeroSection = ({ title, desc, isRwa = false, ttileClasses }) => {
  return (
    <section className={cn("relative overflow-visible  pt-20  lg:pt-[120px]")}>
      <Helmet>
        <link
          rel="canonical"
      ...
      >
        ...
        {title && (
          <h1 className="mt-4 cursor-default text-[42px] font-medium uppercase text-white md:text-[80px] lg:mt-6 lg:max-w-[1300px] xl:mt-8">
            {title}
          </h1>
        )}
