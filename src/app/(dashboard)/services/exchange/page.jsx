...
const Exchange = () => {
  return (
    <section>
      <HeroSection title={"Launch Your White Label Exchange with Ease Today"} />
      <Achievements
        ...
        desc={
          <>
            ...
            <br className="hidden custom1430:block" /> own trading platform with
            minimal development
        ...
        desc={
          <>
            <>
              ...
              scalable platform in weeks — fully branded, fully functional, and
              built to grow.{" "}
            </>
            <br />
            <br />
