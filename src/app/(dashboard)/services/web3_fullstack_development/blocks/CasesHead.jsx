...
export function CasesHead() {
  return (
    <section className="relative w-full">
      <div className="relative mx-auto px-5 py-10 md:px-8 md:pb-[84px] md:pt-[126px] lg:max-w-[1440px] xl:px-[88px]">
        <div className="flex flex-col items-start justify-between xl:flex-row ">
          <div className="flex flex-col gap-5 xl:gap-[60px]">
            ...
            <p className="body my-[40px] max-w-lg text-base leading-6 md:my-[20px] lg:order-2 lg:max-w-[550px]">
