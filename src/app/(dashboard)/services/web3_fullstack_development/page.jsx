        ...
        <Industries
          ...
          desc={
            <>
              ...
              solutions crafted
              <br className="hidden xl:block" /> to address requirements of
              every specific sector. Here are some industries we serve
            </>
          }
        ...
        <ExpertiseServices
          ...
          desc={
            <>
              ...
              <br className="hidden xl:block" /> and is optimized for
              performance
            </>
          }
          data={DevProcessData}
