      ...
      <HeroSection
        title={
          <>
            ...
            <br className="hidden custom1400:block" /> Connect, and Grow Easily
          </>
        }
      ...
      <KeyFeatures
        ...
        desc={
          <>
            ...
            essential asset for users and admins alike. The mini-app is perfect
            for handling large groups, streamlining tasks, and creating
            immersive experiences for users across niches. Designed with
            simplicity at its core, the app provides an intuitive interface
            that’s easy for users to adopt, regardless of their technical
            background
          </>
        }
...
a ton telegram network or building a niche group, the app supports your goals"
      ...
      <div className="relative">
        <KeyFeatures
          ...
          title={
            <>
              Why Social TG Mini-App <br className="hidden custom1400:block" />
              Is Perfect for TON Communities
            </>
          }
          desc={
            <>
              The Social TG Mini-App is built to operate smoothly within the TON
              blockchain ecosystem. It connects directly to TON apps and
      ...
      <ExpertiseServices
        title={
          <>
            Advanced Integrations in <br className="hidden custom1400:block" />{" "}
            Your TG Mini-App
          </>
        }
      ...
      <KeyFeatures
        ...
        title={
          <>
            ...
            Community with Social <br className="hidden custom1400:block" /> TG
            Mini-App
          </>
        }
        desc={
