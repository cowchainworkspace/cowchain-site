      ...
      <Achievements
        ...
        desc={
          <>
            ...
            <br className="hidden custom1430:block" /> business logic — not the
            other way around
          </>
        }
      ...
      <KeyFeatures
        ...
        desc={
          <>
            ...
            already reshaping global industries. AI gives businesses an edge by
            transforming raw data into actionable insights, predicting outcomes,
            and eliminating inefficiencies across the board.
            <br />
            <br />
            In AI for business, we’ve seen everything from financial firms
            optimizing asset allocation in real time to Web3 projects analyzing
            community behavior to guide tokenomics. For example, an AI-powered
            analytics engine can monitor smart contract events across multiple
            chains, detect anomalies in liquidity pools, and generate alerts
            before a depeg or exploit occurs.
            <br />
            <br />
      ...
      <KeyFeatures
        ...
        desc={
          <>
            ...
            turning community engagement into a data-driven economy or designing
            agents that act on-chain with real-time inputs, our focus is on AI
            as a composable layer – not an accessory.
            <br />
            <br />
            This mindset is critical for Web3. In a space where behavior shifts
            overnight and logic often lives across contracts and chains,
            businesses need systems that can evolve as fast as their users do.
            <br />
            <br />
