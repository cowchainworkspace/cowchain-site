    ...
    <section>
      ...
      <Achievements
        ...
        desc={
          <>
            An ICO platform is{" "}
            <span className="violet-gradient-text">an all-in-one solution</span>{" "}
            for <br className="hidden custom1430:block" /> managing every aspect
            ...
            to
            <span className="violet-gradient-text">
              investor relations <br className="hidden custom1430:block" /> and
              compliance
            </span>
            . By leveraging a robust platform,{" "}
            <br className="hidden custom1430:block" />
            you can streamline token issuance, monitor{" "}
            <br className="hidden custom1430:block" /> fundraising progress, and
            execute marketing <br className="hidden custom1430:block" />{" "}
            campaigns with ease
          </>
        }
