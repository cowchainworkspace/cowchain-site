...
import { otherDexServices } from "./utils/data";
    ...
    <>
      ...
      <section className="overflow-visible">
        ...
        <Industries
          ...
          desc={
            <>
              Our decentralized cryptocurrency exchange app development follows
              a structured
        ...
        <KeyFeatures
          ...
          desc={
            <>
              ...
              <br className="hidden lg:block" />
              We consistently deliver secure, scalable platforms while
              maintaining
              <br className="hidden lg:block" />
          ...
          <OtherServices
            title={
              <>
                ...
                we offer <br />
                the following <br />
                <span className="violet-gradient-text">blockchain</span>{" "}
                services:
              </>
            }
