        ...
        <ExpertiseServices
          ...
          desc={
            <>
              ...
              expertise spans smart contract architecture and design with a
              focus on scalability and security, as well as seamless integration
              of smart contracts with traditional systems and external data
              sources via oracles.
            </>
          }
          ...
          <FAQ
            ...
            desc={
              <>
                ...
                <br className="hidden custom1400:block" /> and customer
                compliance
              </>
            }
        ...
        <KeyFeatures
          ...
          desc={
            <>
              ...
              expertise ensures your business stays ahead in the blockchain
              space.
            </>
          }
          noBg={true}
          ...
          <OtherServices
            ...
            title={
              <>
                ...
                , we at <br className="hidden custom1400:block" /> Cowchain
                offer <br className="hidden custom1400:block" /> a wide range of{" "}
                <br className="hidden custom1400:block" />
                <span className="violet-gradient-text">
