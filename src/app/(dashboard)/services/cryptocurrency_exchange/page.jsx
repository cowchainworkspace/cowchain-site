...
const CryptoCurrencyDev = () => {
  return (
    <section className="overflow-visible">
      ...
      <Feedback
        desc="Clients have praised our work, citing our deep expertise in NFT development and blockchain technology. We focus on delivering innovative solutions that meet the unique needs of each project"
      />
      ...
      <KeyFeatures
        ...
        title={
          <>
            The Future of Cryptocurrency <br /> Exchange Platforms
          </>
        }
        desc={
          <>
            The cryptocurrency market is evolving rapidly, and exchanges must
            stay ahead with innovative features and high-assurance designs.
            Whether through advanced crypto trading software or robust crypto
            wallet integration, the future belongs to platforms that prioritize
            performance and user-centric designs. Contact us to create a
            platform that stands out in this dynamic market.
          </>
        }
        noBg={true}
