...
export const DexExpertiseData = [
  {
    title: "Integration Services and Solutions",
    desc: "The decentralized exchange development solutions at Cowchain guarantee that third-party integrations, wallets, payment gateways, and liquidity providers will be seamlessly integrated into your system to ensure operations run without glitches and are accessible for users on different platforms. Using advanced decentralized exchange development, we make sure your platform integrates necessary third-party utilities in a non-compromising way regarding performance or security"
  },
  {
    title: "Bespoke Decentralized Exchange App Development",
    desc: "We offer decentralized exchange development to create unique, user-friendly DEX applications that allow seamless transactions. From crafting smart contracts to building intuitive interfaces, we ensure each platform provides a premium user experience"
  },
  {
...
export const IndustriesDexData = [
  {
    title: "Government",
    text: "For government agencies, decentralized technology offers a secure way to manage public services, voting systems, and identity verification. Our blockchain consulting group assists government organizations in implementing solutions that enhance transparency, reduce bureaucracy, and improve citizen services",
    icon: GovernmentIcon
  },
  {
    title: "Supply Chain Management",
    text: "Technology enhances supply chain transparency by providing end-to-end traceability of goods and materials. Our blockchain consulting services help businesses in the logistics and supply chain industry implement solutions that improve product tracking, reduce fraud, and streamline communication between suppliers and buyers",
    icon: SupplyChain
  },
  {
    title: "Healthcare",
    text: "Security and privacy are crucial in the healthcare sector, where safeguarding sensitive patient information is essential. Blockchain consultants assist healthcare providers in adopting systems that protect data, uphold privacy, and align with regulatory standards, allowing for improved patient care and streamlined operations",
    icon: HelthcareIcon
  }
];

export const DexAppDevData = [
  {
...
export const whyChoosep2pData = [
  {
    title: "P2P Done Right",
    content:
      "Launching a P2P exchange isn’t just about writing code — it’s about building trust, ensuring reliability, and delivering a product that scales with your goals. That’s where experienced development comes in"
  },
  {
    title: "Expertise in Crypto Exchange Software",
    content: `Our team has worked across DeFi, centralized exchanges, P2P protocols, and custom blockchain infrastructure. We bring real-world experience to your project – helping you avoid common pitfalls and ship a platform that’s ready for serious users`
  },
  {
    title: "End-to-End Solutions",
    content: `From concept to post-launch maintenance, we handle every phase of development. Whether you need UI/UX, smart contract engineering, server infrastructure, or integrations with third-party services — we’ve got it covered. That means faster delivery, fewer risks, and a smoother launch overall`
  }
];

export const p2pFAQData = [
  {
    title: "How long does it take to build a P2P crypto exchange?",
    content:
      "Timelines vary depending on features, integrations, and compliance needs. On average, a basic MVP takes 6–8 weeks, while more complex exchanges with custom logic, fiat ramps, or cross-chain support may require up to 12 weeks"
  },
  {
    title: "Can you integrate fiat payments into a decentralized exchange?",
    content: `Yes. While core trading remains wallet-to-wallet, we can integrate fiat on-ramps through third-party providers. This allows users to buy crypto with traditional payment methods while preserving the non-custodial model`
  },
  {
    title: "What makes your P2P platforms different from off-the-shelf scripts?",
    content: `We build platforms around your vision, not someone else’s template. From smart contract architecture to dispute management tools and custom UI, every layer is tailored to your goals – with scalability and security built in from day one`
  }
];
...
export const keyFeaturesp2pData = [
  ...
  },
  {
    ...
    desc: "Modern users expect more than just Bitcoin and Ethereum. We build platforms with multi-currency trading functionality, enabling users to trade a wide range of tokens, stablecoins, and altcoins. This not only expands your potential user base but also increases platform liquidity and utility"
  },
  {
    title: "Crypto Wallet Integration",
    desc: "Secure crypto wallet integration is a must for any P2P platform. We ensure users can connect their wallets effortlessly – whether it’s MetaMask or any other compatible wallet. Built-in encryption and transaction automation ensure funds stay safe while delivering a seamless trading experience"
  }
];

export const howToDevelopp2pData = [
  {
    title: "Planning and Requirements Analysis",
    desc: "We start with your idea and dig into the details: what kind of users you’re targeting, what markets you want to serve, and how your platform should stand out. Then we translate that into a tech blueprint — features, architecture, and smart contract logic"
  },
  {
    title: "Building the Platform",
    desc: "Our dev team builds your platform from the ground up — backend, frontend, and smart contract layers. Everything is tailored for performance, decentralization, and compliance. We also integrate external services like payment providers, liquidity bridges, and KYC modules (if required)"
  },
  {
...
export const challengesp2pData = [
  {
    title: "Ensuring Scalability and Performance",
    desc: "As user activity grows, so do the demands on your system. Matching buyers and sellers in real time, updating order books, and processing transactions — all without downtime — requires robust architecture. We design scalable backend systems and optimize smart contract logic to ensure your exchange can handle volume without bottlenecks"
  },
  {
    title: "Regulatory Compliance",
    desc: "Even in decentralized models, legal considerations still apply. Jurisdictions have different rules around KYC, AML, and digital asset transactions. We help you understand the landscape early on and implement modular compliance tools – so your platform stays adaptable and ready for future regulations"
  }
];

export const paymentSystemData = [
  {
    title: "Support for Fiat Gateways",
    desc: "Enable users to buy cryptocurrencies with traditional payment methods like credit cards or Apple Pay, lowering barriers for new users."
  },
  {
    title: "Instant Cross-Border Payments",
    desc: "Facilitate real-time, low-cost international transactions by eliminating intermediaries and leveraging blockchain efficiency."
  },
  {
    title: "POS System Integration",
    desc: "Allow businesses to accept cryptocurrencies in physical stores through seamless Point-of-Sale (POS) system integration."
  }
];

export const benefitsp2pData = [
  {
    title: "Tailored Trading Solutions",
    text: "No two platforms are alike. We design custom trading solutions that match your roadmap — whether you need dispute resolution tools, on-chain reputation scoring, or fiat ramps. From user flow to smart contract logic, everything can be shaped to fit your strategy",
    icon: TailorTradingIcon
  },
  {
    title: "Enhanced Security Features",
    text: "P2P doesn’t mean compromise. Our systems include built-in encryption, two-factor authentication, DDoS protection, and real-time fraud detection. You get a trading platform that’s not only flexible but hardened for secure peer-to-peer trading in any region",
    icon: EnhanceSecurityIcon
  },
  {
