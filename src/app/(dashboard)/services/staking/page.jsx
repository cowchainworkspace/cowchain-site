  ...
  return (
    <section className="overflow-visible">
      ...
      <ExpertiseServices
        title={
          <>
            Advantages of <br className="hidden custom1400:block" /> Using White
            Label <br className="hidden custom1400:block" /> Staking{" "}
        ...
        desc={
          <>
            <p>
              ...
              investors are turning to white label staking as a practical way to
              launch staking services. Some key applications include:
            </p>
            <br />
            <ul class="list-disc pl-6">
              ...
              <li>
                DeFi protocols integrating staking to increase TVL and liquidity
                participation
              </li>
              <li>
      ...
      <KeyFeatures
        ...
        desc={
          <>
            ...
            secure, and scalable staking platforms to remain competitive. White
            label staking solutions provide a budget-friendly, high-performance
            way to enter the market, drive adoption, and maximize revenue
            potential.
          </>
        }
        noBg={true}
