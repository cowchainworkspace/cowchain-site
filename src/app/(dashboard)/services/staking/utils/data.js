...
import { YouCustomizeIcon } from '@/assets/svgComponents/staking/YouCustomizeIcon';
...
export const advantagesStakingData = [
  {
    title: "Time and Cost Savings",
    desc: "Developing a staking platform from scratch requires significant technical expertise, time, and financial investment. White label solutions eliminate these barriers by providing a pre-built system that reduces development time and lowers costs, allowing businesses to launch a staking service quickly."
  },
  {
    title: "Enhanced Security Features",
    desc: "Security is critical in staking platform development. White label staking platforms come with built-in security measures, including smart contract validation, node protection, and automated fraud detection. These features ensure that funds remain secure, transactions are protected, and users can stake assets with confidence."
  },
  {
...
export const steByStepStakingData = [
  {
    title: "We Provide a Battle-Tested Staking Infrastructure",
    text: "Forget about expensive development cycles. Our staking software solutions are fully built, audited, and optimized for performance. No guesswork — just a proven system ready for deployment",
    icon: WeProvideStakingIcon
  },
  {
    title: "Blockchain Integration",
  ...
  {
    title: "You Customize to Match Your Brand & Strategy",
    text: "Unlike rigid, off-the-shelf solutions, our platform adapts to your needs. You get full branding control — apply your logo, colors, and domain; flexible staking mechanics, set lock-up periods, APYs, and custom rewards, multi-asset support, Integrate your token or allow users to stake multiple assets",
    icon: YouCustomizeIcon
  },
  {
    title: "Fast Deployment & Ongoing Support",
    text: "Why spend months building when you can go live in weeks? With our white label staking platform, you geta rapid setup process — start onboarding users fast, technical support — our team ensures a smooth launch and ongoing updates and scalability from day one — as your user base grows, your staking platform scales effortlessly",
    icon: FastDevIcon
  }
];
