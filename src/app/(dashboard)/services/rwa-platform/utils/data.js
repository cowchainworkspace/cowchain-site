...
import { RealEstateIcon } from "@/assets/svgComponents/rwaPlatworm/RealEstateIcon";
import { UseOfWalletsIcon } from "@/assets/svgComponents/rwaPlatworm/UseOfWalletsIcon";
import { IntegrationWithSecIcon } from "@/assets/svgComponents/staking/IntegrationWithSecIcon";
...
export const otherStakingServices = [
  {
    text: "UI / UX Design",
    author:
  ...
  },
  {
    ...
    author:
      "From front-end design to back-end systems, our full-stack development team delivers scalable, high-performance web applications that meet your business needs"
  }
];
...
export const stakingFAQData = [
  ...
  {
    title:
      "What key elements should be included in a white-label web design contract?",
...
export const essentialStakingData = [
  {
    title: "Blockchain Integration",
    desc: "A robust staking platform setup requires seamless integration with multiple blockchain networks. White label staking solutions support various consensus mechanisms, including Proof-of-Stake (PoS), Delegated PoS (DPoS), and Liquid Staking Protocols, ensuring wide compatibility across different blockchain ecosystems"
  },
  {
    title: "User-Friendly Interface",
    desc: "A well-designed, intuitive interface ensures smooth user onboarding and engagement. Custom staking software must include clear staking options, real-time yield tracking, and portfolio management tools to enhance the user experience"
  }
];
...
export const benefitsOfRwaData = [
  {
    title: "Enhanced Liquidity for RWA Assets",
    desc: "Traditionally, real-world assets lack liquidity and are difficult to trade. Tokenizing these assets through RWAs allows them to be easily traded on blockchain networks, unlocking new liquidity opportunities. This digital liquidity is especially beneficial for assets like real estate, which typically require lengthy sales processes. Investors can now trade fractions of assets using an RWA wallet, accessing previously untapped liquidity pools"
  },
  {
    title: "Improved Security with",
    desc: "The safety of crypto RWA is rooted in blockchain’s decentralized nature. Smart contracts and tamper-proof ledgers reduce fraud, ensuring ownership integrity. Platforms leveraging protocols like Aspis Security provide an additional layer of protection, safeguarding tokenized assets against malicious activity"
  },
  {
    title: "Scalability and Flexibility",
    desc: "A staking platform must adapt to growing demand. White label solutions are designed for scalability, allowing businesses to add more assets, expand to new blockchain networks, and integrate custom features without disrupting operations."
  }
];

export const challengesRwaData = [
  {
    desc: "Although RWA tokenization holds great potential, it is not without its challenges. By addressing these issues, RWA platforms continue to evolve, making crypto RWA more accessible and secure"
  },
  {
    title: "Regulatory Compliance",
    desc: "Many regions lack clear guidelines for blockchain-based assets. Platforms mitigate this by adopting global standards and secure frameworks"
  },
  {
    title: "Trust and Adoption",
    desc: "Educating investors about the benefits of RWA blockchain systems is crucial for adoption"
  },
  {
    title: "Technological Barriers",
    desc: "Ensuring smooth blockchain interactions requires advanced tools like Base Sepolia RPC and Base RPC Metamask"
  }
];

export const keyComponentsRwaData = [
  {
    title: "Blockchain Infrastructure",
    desc: "A robust RWA blockchain infrastructure ensures transparency and scalability. Using frameworks like Base Sepolia RPC and integrations such as Base RPC Metamask, platforms facilitate seamless blockchain interactions, enabling secure and efficient asset tokenization"
  },
  {
    title: "Integration with RWA Wallets",
    desc: "RWA wallet is essential for managing tokenized assets, allowing users to securely store, transfer, and trade RWAs. By simplifying asset management and providing robust security, these wallets enhance accessibility and confidence for investors"
  }
];
...
export const keyFeaturesRwaPlatformData = [
  {
    title: "Digital representation",
    text: "Of RWA real-world assets on blockchains",
    icon: UseOfWalletsIcon
  },
  {
    title: "Use of wallets",
    text: "Such as the RWA wallet, for managing tokenized assets",
    icon: DigitalRepresentationIcon
  },
  {
    title: "Integration with secure protocols",
    text: "Like Aspis Security for risk mitigation",
    icon: IntegrationWithSecIcon
  }
];

export const realWorldRwaPlatformData = [
  {
    title: "Real Estate",
    text: "Tokenization of properties allows for fractional ownership and global trading",
    icon: RealEstateIcon
  },
  {
    title: "Art and Collectibles",
    text: "High-value artworks can be divided into tokens, enabling broader investment opportunities",
    icon: ArtAndCollIcon
  },
  {
    title: "Commodities",
    text: "Gold, oil, and agricultural products are being tokenized for easier trading and increased market reach",
