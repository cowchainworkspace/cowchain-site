  ...
  return (
    <section>
      ...
      <Achievements
        ...
        desc={
          <>
            A <span className="violet-gradient-text">crypto wallet app</span> is
            a secure digital tool
            <br className="hidden custom1430:block" /> that allows users to
            store, send, and receive
            <br className="hidden custom1430:block" /> cryptocurrencies directly
            ...
            <span className="violet-gradient-text">mobile crypto wallets</span>{" "}
      ...
      <KeyFeatures
        title={"Secure Your Assets with a Mobile Crypto Wallet for Easy Access"}
        topBorder={false}
      ...
      <KeyFeatures
        ...
        desc={
          <>
            ...
            crypto wallets are contributing to sustainable practices within the
            blockchain ecosystem.
            <br />
            <br />
            By enabling mobile-first solutions, these wallets reduce reliance on
            energy-intensive hardware. As the crypto industry evolves,
