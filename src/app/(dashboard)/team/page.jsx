            ...
            <div className="flex flex-col justify-between xl:flex-row">
              ...
              <div className="max-w-[781px] text-secondary">
                <p className="mb-5 text-secondary">
                  ...
                  traditional Web2 development, Mykhailo realized that he’s
                  “been there, seen that, done that.” So once he got involved in
                  a Web3 project, he saw the potential for innovation in this
                  industry that was missing in Web2 and suddenly knew he wanted
