import {agent, brc20 as brc20Img, crossChain, gbc as gbcImage, hybrid as hybridImage, m2eNewOne, memolut, pixelVerse, stars as starsImage, tenet as tenetImage } from "./../../../../public/projects"
...
const stars = {
  ...
  img: starsImage,
  cardClasses: "pb-4 px-4 xl:px-0 xl:pb-[17px]",
  relatedSlugs: ["agnt", "stars", "pixel-verse"  ],
}

const allProjects = [memelut, gbc, tenet, retrobridge, agnt, pixelverse, stepApp, hybrid, brc20, stars]
