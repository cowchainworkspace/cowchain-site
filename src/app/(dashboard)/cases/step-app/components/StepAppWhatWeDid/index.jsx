...
const StepAppWhatWeDid = () => {
  return (
    <section className="pb-[70px] pt-30">
      <div className="mx-auto max-w-[1440px] px-[97px]">
        <h2 className="mb-[54px] font-roc text-[55.24px] font-medium leading-90">
          What we did
        </h2>
        <div className="relative mb-[70px] grid grid-cols-2 gap-[37px]">
          <div className="border-t-[0.5px] border-white-50 pt-8">
            <h3 className="mb-4 font-manrope text-xs font-medium uppercase leading-5  tracking-[2px] text-white">
              CHALLENGE
            </h3>
            <p className="text-sm font-[450] leading-6 text-white-70">
