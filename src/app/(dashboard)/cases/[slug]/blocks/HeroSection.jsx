...
export const HeroSection = ({ title, linkTitle, tags }) => {
  return (
      ...
      <div className="relative pb-8 md:px-8 md:pb-12 lg:px-16 xl:px-24">
        <div className="mb-6 flex gap-4">
          ...
          <Image
            ...
            src={arrow}
          />
          <span className="text-sm text-white md:text-base">{linkTitle}</span>
        </div>
        <div className="flex flex-col items-center justify-center">
          <h1 className="my-6 text-center uppercase">{title}</h1>
